...
print(evalGAN(valloader,load_path = './models/Model_SGAN/20_Generator',sampleImagesName="SGAN_val", unet=False))
...
evalGAN(testloader, './models/Model_SGAN/20_Generator',sampleImagesName="SGAN_test", unet=False)